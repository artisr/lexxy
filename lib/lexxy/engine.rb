  ...
  class Engine < ::Rails::Engine
    ...
    initializer "lexxy.sanitization" do |app|
      ActiveSupport.on_load(:action_text_content) do
        ...
        ActionText::ContentHelper.allowed_attributes = default_allowed_attributes + %w[ controls poster data-language data-lexxy-toggle data-lexxy-toggle-target style value start ]
